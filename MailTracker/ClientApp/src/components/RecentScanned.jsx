        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              {props.type === "Incoming" ? <TableCell>Product Type</TableCell> : <React.Fragment></React.Fragment>}
            ...
            {mailList &&
              mailList.map((m) => (
                <TableRow key={m.externalMailID}>
                  ...
                  {props.type === "Incoming" ?   <TableCell>{m.productType}</TableCell> : <React.Fragment></React.Fragment>}
                  <TableCell>
